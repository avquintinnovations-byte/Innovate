...
if("TRUE" STREQUAL "TRUE")
  set(point_lio_unilidar_SOURCE_PREFIX /home/hellion/catkin_point_lio_unilidar/src/point_lio_unilidar)
  set(point_lio_unilidar_DEVEL_PREFIX /home/hellion/catkin_point_lio_unilidar/devel)
  ...
  set(point_lio_unilidar_INSTALL_PREFIX /home/hellion/catkin_point_lio_unilidar/install)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_lio_unilidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hellion/catkin_point_lio_unilidar/src/point_lio_unilidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hellion/catkin_point_lio_unilidar/devel/lib;/opt/ros/noetic/lib)
